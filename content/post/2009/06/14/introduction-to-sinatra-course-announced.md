...
<div>
  ...
  <p>
    The course starts on 11th July 2009 and runs for a week. You first need to <a href="http://rubylearning.org/">register on the site</a> and then <a href="http://rubylearning.org/class/course/view.php?id=40">enroll into the course</a>. The <strong>Sinatra eBook</strong> that covers the entire course contents, will be available for download after 5th July 2009.
  </p>
  ...
  <ul>
    ...
    <li>
      After the first 30 registrations, Course Fee US$ 12 per participant.
    </li>
  </ul>
