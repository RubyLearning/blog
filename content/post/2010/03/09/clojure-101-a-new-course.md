...
Shoes, JRuby and Sinatra. Since 2005, over 20,000 participants spread
across 140+ countries have learned Ruby and other<!--more--> Ruby related timely
topics. This has been possible due to the extensive support provided by
the mentors of these courses. RL strives hard to improve the methodology
and course content based on the extensive and critical feedback we
receive. Thanks to **YOU**, people like Fabio Akita and companies like
Locaweb who make this possible. [Our
Alumni](http://rubylearning.com/other/testimonials.html) are our best
ambassadors.

You kept asking for it and so here it is – the new introductory, free,
intensive, online course that helps you get started with **Clojure**
programming.

## Sponsor

[![Runa
Inc.](http://rubylearning.com/images/runa-forwebsites.jpg "Runa Inc.")](http://runa.com/)

Runa aims to provide small-to-not-so-large online retailers with
tools/services that companies like amazon.com use/provide. These smaller
guys can’t afford to do anything on that scale, but by using their SaaS
...
(OCI)](http://rubylearning.com/images/OCIlogo.jpg "Object Computing, Inc. (OCI)")](http://www.ociweb.com/)

Our special thanks go to **Rich Hickey** for providing us with this
exciting new language as well as **Mark Volkmann** from Object
Computing, Inc. for generously giving us permission to use his articles
as teaching material for this course.
...
Clojure that you will end up using every day. The course topics are
tentative and could change with the feedback received:
...
Anyone with an intermediate programming experience. **People who have no
previous exposure to Lisp and/or Clojure can get up-to-speed with
Clojure with these [Clojure
Notes](http://clojure-notes.rubylearning.org/).**
...
engineer in Vienna, Austria. Michael fell in love with Clojure on first
sight sometime in early 2009, but unfortunately never seems to have as
much time to work with it as he wants to and started being a mentor for
...
![Baishampayan
Ghose](http://rubylearning.com/images/bg.jpg "Baishampayan Ghose")

Baishampayan Ghose ([Twitter](http://twitter.com/ghoseb) /
[profile](http://www.google.com/profiles/b.ghose?hl=en)) is a keen
student of Computer Science with a lot of interest in large-scale,
concurrent applications, programming languages and operating systems. An
avid self-learner, he taught himself C programming when he was 17 and
has kept on learning different programming languages and technologies
ever since.

Baishampayan is a polyglot programmer – proficient in Python,
Javascript, Clojure, ANSI Common Lisp, C and is picking up Erlang &
Haskell to add to his repertoire of programming languages. Apart from
that, he is a regular speaker in Indian technology conferences and is a
well known face in the Indian FOSS scene.

He is currently a co-founder and the CTO of [Infinitely Beta
Technologies](http://infinitelybeta.com/), a Pune based startup.

### Daniel Solano Gómez

![Daniel Solano
Gómez](http://rubylearning.com/images/portrait.jpg "Daniel Solano Gómez")

Daniel Solano Gómez ([Twitter](http://twitter.com/deepbluelambda) /
[blog](http://www.deepbluelambda.org/)) is the founder of Sattvik
Software & Technology Resources, a software development company based in
Houston, Texas. He studied mathematics at the University of Texas at
Austin, but he discovered his passion for programming and computers as a
child. Daniel has been developing software professionally for over a
decade, primarily with C++ and Java. He started learning about and
developing with Clojure in late 2009.

### Michał Marczyk

Michał Marczyk is a PhD student doing research in logic / universal
algebra in Kraków, Poland, always trying to coerce the computer into
proving his theorems for him. His programming background is
predominantly in functional programming; mostly in Scheme, Haskell and
...
-   You first create an account on the site (see right-hand top corner
    of the [RubyLearning.org](http://rubylearning.org/) site). An email
    will be sent to your registered email address. This email contains a
    link to confirm your account. Please click on that link.
-   Once your registration has been confirmed, login to the site and
    click on the [Clojure 101 1st
    Batch](http://rubylearning.org/class/course/view.php?id=53) link. It
    will ask you for an enrollment key. Please enter the Enrollment Key
    **Clojure101** and you would be enrolled in this course.
-   Update your profile (with photo) and introduce yourself at the
    Course Social Forum.
...
-   The mentor shall highlight the important points that you need to
    remember for that week’s session.
...
-   Participate in the forum for asking and answering questions or
    ...
    the forum. This forum is subscribed by several hundred people, so
    please be aware that these messages are considered as noises by many
    people.

### Outline of Work Expectations:

1.  The course starts on a Saturday and the new course material will be
    available every Saturday.
2.  Most of the weeks, you will have exercises to solve. These are there
    to help you assimilate whatever you have learned till then.
3.  Some weeks may have some mid-week additional assignments / food for
    thought articles / programs
4.  **Above all, do participate in the relevant forums. Past
