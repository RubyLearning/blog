...
to **YOU** and people like Fabio Akita who make this possible. [Our
Alumni](http://rubylearning.com/other/testimonials.html) are our best
ambassadors.

You kept asking for it and so here it is – the second batch of the
...
In this course, you will learn the essential features of Clojure that
you will end up using every day. The course topics are tentative and
could change with the feedback received:
...
![Anthony
Simpson](http://rubylearning.com/images/cropped.jpg "Anthony Simpson")

Anthony Simpson ([Twitter](http://twitter.com/IORayne) /
[Blog](http://blog.acidrayne.net)) is a young, ambitious programmer in
Eldridge, Alabama. His first language having been Haskell, the majority
of his time with programming has been with functional programming
languages, most of which has been spent with Clojure. A language person,
he enjoys learning about new languages and improvements they make on
existing languages. Non-computer-related interests include,
(roller)skating, all aspects of music, and hacking life.

### Isaac Hodes

![Isaac Hodes](http://rubylearning.com/images/Isaac.jpg "Isaac Hodes")

Isaac ([Twitter](http://twitter.com/ihodes) /
[Blog](http://www.copperthoughts.com/)) is a Math major studying just
about anything he can get his hands on. He likes to program, cook, and
read as much as possible in his spare time. Programming in Clojure is
what he does on vacation; it’s that much fun.
...
-   Once your registration has been confirmed, login to the site and
    [enroll into the Clojure 101
    course](http://rubylearning.org/class/course/view.php?id=62).
-   Update your profile (with photo) and introduce yourself at the
    Course Social Forum.

## Course Fees

The course fee is **US\$ 5 per participant**. The course fee goes
...
1.  The course starts on a Monday and the new course material will be
